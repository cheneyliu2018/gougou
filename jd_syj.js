...
===============Surge=================
赚京豆-瓜分京豆 = type=cron,cronexp="10 5,7 * * *",wake-system=1,timeout=3600,script-path=jd_syj.js

============小火箭=========
赚京豆-瓜分京豆 = type=cron,script-path=jd_syj.js, cronexpr="10 5,7 * * *", timeout=3600, enable=true
 */
