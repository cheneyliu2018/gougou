...
================Loon==============
[Script]
cron "10 0,7,23 * * *" script-path=jd_syj.js, tag=瓜分京豆(微信小程序)

===============Surge=================
瓜分京豆(微信小程序) = type=cron,cronexp="10 5,7 * * *",wake-system=1,timeout=3600,script-path=jd_syj.js

============小火箭=========
瓜分京豆(微信小程序) = type=cron,script-path=jd_syj.js, cronexpr="10 5,7 * * *", timeout=3600, enable=true
 */
